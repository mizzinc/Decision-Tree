...
<div class="dt_simple_float">
	<div class="dt_dashboard_box">
		...
		<form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
			...
			<table>
				<tr>
					<td><input type="hidden" name="on0" value="Version">Version</td>
				</tr>
				<tr>
					<td><select name="os0">
...
<div class="dt_simple_float">
	<div class="dt_dashboard_box">
		...
		<div class="dt_instruction_block">
			...
			<p>
				<b>Support</b><br>
				Need help? Visit the <a href="http://sidecar.tv/decision_tree/">Decision Tree</a> page for all the
				details.
			<p>
				<b>Privacy & Terms Of Service</b><br>
				This Plug-in is covered by our <a href="http://sidecar.tv/about-privacy-tos/">Terms Of Service</a> and
				<a href="http://sidecar.tv/about-privacy-tos/">Privacy Policy</a>.
		</div>
	</div>
	...
	<div class="dt_dashboard_box">
		...
		<div class="dt_instruction_block">
			...
			or your 3rd grade teacher, just how this plugin is used. See more details on our <a
				href='http://sidecar.tv/about-privacy-tos/'>Privacy Policy</a>.
			<p>
